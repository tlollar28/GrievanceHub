...
```text
Steward / API client
  → FastAPI routes (/cases, /sources, export routes)
...
Obsolete Cross-Craft Analyzer / SPBS upload and Excel-report routes have been
removed from `app/main.py`. GrievanceHub no longer exposes that product surface.
